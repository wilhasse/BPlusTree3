...
class TestPerformanceRegression:
    ...
    def test_insertion_performance(self):
        ...
        duration = elapsed()
        assert duration < self.INSERTION_THRESHOLD_10K, \
    ...
    def test_lookup_performance(self):
        ...
        duration = elapsed()
        assert duration < self.LOOKUP_THRESHOLD_10K, \
    ...
    def test_deletion_performance(self):
        ...
        duration = elapsed()
        assert duration < self.DELETION_THRESHOLD_10K, \
    ...
    def test_iteration_performance(self):
        ...
        assert duration < self.ITERATION_THRESHOLD_10K, \
    ...
    def test_range_query_performance(self):
        ...
        assert duration < self.RANGE_QUERY_THRESHOLD, \
