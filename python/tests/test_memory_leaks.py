...
class TestMemoryLeaks:
    ...
    def test_insertion_deletion_cycle_no_leak(self):
        ...
        assert growth < 100, f"Too many objects leaked: {growth} new objects after cycles"
    ...
    def test_tree_destruction_releases_nodes(self):
        ...
        alive_count = sum(1 for ref in weak_refs if ref() is not None)
        assert alive_count == 0, f"{alive_count} objects still alive after tree destruction"
    ...
    def test_update_operations_no_leak(self):
        ...
        growth = final_objects - initial_objects
        assert growth < 1000, f"Too many objects leaked during updates: {growth} new objects"
